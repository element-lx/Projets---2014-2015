...
<!--CSS/LESS menu vertical-->
                    ...
                    <div class="champs_admin_mod">
                        ...
                        <?php
                            ...
                            echo "<ul>";                                                     
                                while($rangee = mysqli_fetch_assoc($listEvent))
                                    {
                                    echo "<li><a class='liste_mod' href='index.php?page=AdminEvenementsModifier2&id_evenement=".$rangee['id_evenement']."';>".$rangee['titre']."</a></li>";
                                
                                    echo "<div class='espace_mod'></div>";
                                    }
