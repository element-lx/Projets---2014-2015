...
<!--CSS/LESS menu vertical-->
                    <nav class="">
                        ...
                        <div class="rectangleTransAjout3 "></div >
                        <div class="rectangle2_menuAdminAjout3 ">
                        ...
                        <div class="rectangleTransAjout4 "></div> 
                    </nav> 
                     <p class="white praetor addReussie">Evenement Supprimer</p>  // Message de confirmation du document supprimer                         
